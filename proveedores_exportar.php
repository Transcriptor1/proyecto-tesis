<?php
/**
 * Modulo Proveedores - Descargar Excel.
 *
 * Formulario para elegir un rango de fechas y descargar en Excel los
 * registros de la tabla `proveedores` cuya fecha_registro este en ese
...
<head>
  <meta charset="UTF-8">
  <title>Proveedores - Descargar Excel - SIRAD</title>
...
<body>
  ...
  <main>
    ...
    <div class="page-actions">
      ...
      <a href="proveedores_exportar.php" class="active">Descargar Excel</a>
    </div>
