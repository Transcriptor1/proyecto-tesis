<?php
/**
 * Modulo Talleristas - Descargar Excel.
 *
 * Formulario para elegir un rango de fechas y descargar en Excel los
 * registros de la tabla `talleristas` cuya fecha_registro este en ese
...
<head>
  <meta charset="UTF-8">
  <title>Talleristas - Descargar Excel - SIRAD</title>
...
<body>
  ...
  <main>
    ...
    <div class="page-actions">
      ...
      <a href="talleristas_exportar.php" class="active">Descargar Excel</a>
    </div>

    <div class="export-bar">
      <form method="GET" action="exportar.php">
        <input type="hidden" name="modulo" value="talleristas">
